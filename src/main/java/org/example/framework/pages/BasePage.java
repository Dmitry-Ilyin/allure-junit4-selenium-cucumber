...
public class BasePage {
     ...
     * Фильтровать атрибут
     *
     * @param value - веб-элемент
     */
    protected String attributeFilter(String value) {
        return value.trim().replaceAll("\\s+", "");
    }

    /**
     * Сместиться к элементу, с помощью класса Actions-Объект для имитации реального поведения мыши или клавиатуры
     *
     * @param element - веб-элемент, к которому надо сместиться
     */
